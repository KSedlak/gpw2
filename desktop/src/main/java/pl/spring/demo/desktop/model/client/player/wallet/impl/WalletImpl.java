...
public class WalletImpl implements Wallet {
	...
	@Autowired
	public WalletImpl(@Value("${player.startPLN}") Double startPLN,
			@Value("${player.startForeginCurrency}") Double startEURO) {
	...
	public void removeFromWallet(Currency c, Double number) {
		logger.info("Client remove from wallet currency: " + c.getName() + " quantity: " + number);
