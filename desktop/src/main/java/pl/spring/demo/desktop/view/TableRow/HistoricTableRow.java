...
public class HistoricTableRow {
	...
	public HistoricTableRow(SimpleStringProperty dateString, SimpleDoubleProperty plProperty,
			SimpleDoubleProperty euroProperty, SimpleDoubleProperty stockProperty, SimpleDoubleProperty allProperty) {
		super();
